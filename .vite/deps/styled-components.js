import { isPropValid, unitlessKeys } from './chunk-W4TI35DA.js';
import { __commonJS, __toESM, require_react } from './chunk-BHZAVQOK.js';
        ...
        switch (charat(value, length2 + 1)) {
          ...
          case 115:
            return ~indexof(value, 'stretch')
              ? prefix(replace(value, 'stretch', 'fill-available'), length2, children) +
                  value
              : value;
        }
      break;
...
var b = function (t, n) {
  if (true) {
    var o2 = n ? ' with the id of "'.concat(n, '"') : '',
      s2 =
        'The component '.concat(t).concat(o2, ' has been created dynamically.\n') +
...
function re(e, t, n) {
  if ((void 0 === n && (n = false), !n && !oe(e) && !Array.isArray(e))) return t;
  if (Array.isArray(t)) for (var o2 = 0; o2 < t.length; o2++) e[o2] = re(e[o2], t[o2]);
...
var le = (function () {
  ...
  return (
    ...
    (e.prototype.getGroup = function (e2) {
      ...
      for (
        var n = this.groupSizes[e2], o2 = this.indexOfGroup(e2), r2 = o2 + n, s2 = o2;
        s2 < r2;
        s2++
      )
...
var ge = function (e, t) {
  for (
    var n,
      o2 = (null !== (n = t.textContent) && void 0 !== n ? n : '').split('/*!sc*/\n'),
      r2 = [],
      s2 = 0,
      i2 = o2.length;
    s2 < i2;
    ...
    if (a2) {
      ...
      if (c2) {
        var l2 = 0 | parseInt(c2[1], 10),
          u2 = c2[2];
        0 !== l2 && (fe(u2, l2), ve(e, u2, c2[3]), e.getTag().insertRules(l2, r2)),
          (r2.length = 0);
      } else r2.push(a2);
    }
  }
          ...
          for (
            var t = e3.getTag(),
              ...
              r3 = function (n3) {
                ...
                var a2 = ''.concat(f, '.g').concat(n3, '[id="').concat(r4, '"]'),
                  c2 = '';
                void 0 !== s3 &&
...
function Me(e) {
    ...
    l2 = (0, import_react.useMemo)(
      function () {
        ...
        return (
          e.sheet
            ? (t2 = e.sheet)
            : e.target && (t2 = t2.reconstructWithOptions({ target: e.target }, false)),
  ...
  return (
    ...
    import_react.default.createElement(
      ke.Provider,
      { value: { shouldForwardProp: e.shouldForwardProp, styleSheet: l2, stylis: u2 } },
      import_react.default.createElement(xe.Provider, { value: u2 }, e.children),
    )
  );
}
var Fe = (function () {
...
function Ge(e, t, n, o2) {
  ...
  if (Q(e)) {
    if (!Q((s2 = e)) || (s2.prototype && s2.prototype.isReactComponent) || !t) return [e];
    var r2 = e(t);
    return (
      'object' != typeof r2 ||
        Array.isArray(r2) ||
...
function Xe(e) {
  var n = import_react.default.useContext(He),
    r2 = (0, import_react.useMemo)(
      function () {
        return (function (e2, n2) {
          ...
          if (Q(e2)) {
            var o2 = e2(n2);
            if (null === o2 || Array.isArray(o2) || 'object' != typeof o2) throw ce(7);
            return o2;
          }
          if (Array.isArray(e2) || 'object' != typeof e2) throw ce(8);
  ...
  return e.children
    ? import_react.default.createElement(He.Provider, { value: r2 }, e.children)
    : null;
}
var Ze = {};
...
function Qe(e, r2, s2) {
  var i2 = ee(e),
    ...
    v2 =
      r2.displayName && r2.componentId
        ...
        : r2.componentId || f2,
    g2 = i2 && a2.attrs ? a2.attrs.concat(d).filter(Boolean) : d,
  ...
  function O2(e2, r3) {
    return (function (e3, r4, s3) {
      ...
      return (
        ...
        (S3[M(g3) && !_.has(g3) ? 'class' : 'className'] = E2),
        (S3.ref = s3),
        (0, import_react.createElement)(g3, S3)
      );
    })(D2, e2, r3);
  }
  O2.displayName = y2;
  ...
  return (
    ...
    (D2.displayName = y2),
    (D2.foldedComponentIds = i2 ? te(a2.foldedComponentIds, a2.styledComponentId) : ''),
      ...
      set: function (e2) {
        this._foldedDefaultProps = i2
          ? (function (e3) {
              ...
              for (var o2 = 0, r3 = t; o2 < r3.length; o2++) re(e3, r3[o2], true);
              return e3;
            })({}, a2.defaultProps, e2)
          : e2;
      },
...
function at(n) {
  ...
  var i2 = nt.apply(void 0, __spreadArray([n], r2, false)),
    a2 = 'sc-global-'.concat(x(JSON.stringify(i2))),
    c2 = new it(i2, a2);
  b(a2);
  var l2 = function (e) {
    var t = Ve(),
      n2 = import_react.default.useContext(He),
      r3 = import_react.default.useRef(t.styleSheet.allocateGSInstance(a2)).current;
    return (
  ...
  function u2(e, n2, o2, r3, s3) {
    if (c2.isStatic) c2.renderStyles(e, g, o2, s3);
    else {
...
function ct(t) {
  ...
  var r2 = ne(nt.apply(void 0, __spreadArray([t], n, false))),
    s2 = x(r2);
  return new Fe(s2, r2);
}
function lt(e) {
  var n = import_react.default.forwardRef(function (n2, r2) {
    ...
    return (
      ...
      import_react.default.createElement(e, __assign({}, n2, { theme: s2, ref: r2 }))
    );
  });
